    ...
    >
      ...
      <div className="flex flex-col justify-items-start w-full h-1/2 p-10">
        <div className="flex justify-between items-center w-full">
          ...
          <h1 className="text-xl font-bold text-orange-400">{restaurant.price}</h1>
        </div>
        <h1 className="text-lg font-medium text-orange-400">
          ⭐ {restaurant.rating}
        </h1>
        ...
        <div className="h-1/4" />
        <h1 className="text-right font-thin text-orange-500">
